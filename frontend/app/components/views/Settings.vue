...
import ApplicationSettingsTab from "~/components/settings/ApplicationSettingsTab.vue";
import BackupTab from "~/components/settings/BackupTab.vue";
import BuddiesTab from "~/components/settings/BuddiesTab.vue";
import DataManagementTab from "~/components/settings/DataManagementTab.vue";
import DiveSitesTab from "~/components/settings/DiveSitesTab.vue";
