...
import { filledIconStyle, importDraftSeed, isImportComplete, effectiveImportDraft, missingImportFields, normalizeRequiredLogbookFields, paddedDiveIndex, isCommittedDive } from "~/shared/utils/core.js";
import { NAV_ITEMS } from "~/navigation.js";
import { currentRouteState as getCurrentRouteState, handleRouteNavigation as handleAppRouteNavigation, initializeLegacyHashRoute, navigateToAppRoute as navigateAppRoute, syncRouteMode as syncAppRouteMode } from "~/routing/app-navigation.js";
import { DEFAULT_SETTINGS_SECTION, SETTINGS_SECTION_IDS, MAIN_ROUTE_BY_VIEW, encodePathSegment } from "~/routing/routes.js";
import { createPreferenceState, detachSystemThemeListener, initializePreferences, setLocale, setThemePreference, syncSystemTheme, translate } from "~/shared/composables/app-preferences.js";
import { createManualDiveDraft } from "~/shared/utils/dive-drafts.js";
import { resolveThemePreference } from "~/shared/utils/preferences.js";
