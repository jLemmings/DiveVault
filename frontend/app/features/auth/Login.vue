            ...
            <div class="relative mt-6 space-y-4 sm:mt-8 sm:space-y-5">
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between gap-3">
                  ...
                  <UButton @click="showPassword = !showPassword" type="button" class="text-[0.65rem] font-semibold uppercase tracking-[0.16em] text-primary transition-colors hover:text-white">
